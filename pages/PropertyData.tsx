      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className={`flex items-center gap-2 px-6 py-4 rounded-2xl text-[11px] font-black transition-all border shadow-sm ${
              isFilterVisible ? 'bg-indigo-50 border-indigo-200 text-indigo-600' : 'bg-white border-slate-200 text-slate-600 hover:border-indigo-300'
            }`}
          >
